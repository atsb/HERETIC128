...
#if (APPVER_HERETICREV < AV_HR_TIC12) // VERSIONS RESTORATION: Moved to R_SetupFrame
		yslope[y] = FixedDiv ((viewwidth<<detailshift)/2*FRACUNIT,
			abs(((y-centery)<<FRACBITS)+FRACUNIT/2));
#endif

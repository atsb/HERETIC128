...
#if (APPVER_HERETICREV >= AV_HR_TIC12) && (defined __WATCOMC__)
//#ifdef __WATCOMC__
...
#if (APPVER_HERETICREV < AV_HR_TIC12) // VERSIONS RESTORATION: But not before v1.0
...
void G_WriteDemoTiccmd (ticcmd_t *cmd)
{
#if (APPVER_HERETICREV < AV_HR_TIC10S) // 0x10 is Q's scan code
	if (gamekeydown[0x10])
#else

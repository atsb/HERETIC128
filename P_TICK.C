...
#if (APPVER_HERETICREV < AV_HR_TIC12) // VERSIONS RESTORATION: A HACK
#define SV_WriteWord(val) *save_p_word++ = (val)
#endif
...
void P_ArchiveWorld(void)
{
	...
	side_t *si;
#if (APPVER_HERETICREV < AV_HR_TIC12)
	unsigned short *save_p_word = (unsigned short *)save_p;
#endif
...
#else // APPVER_HERETICREV >= AV_HR_TIC12
		if(th->function == T_MoveCeiling)
		{

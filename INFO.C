...
#if (APPVER_HERETICREV < AV_HR_TIC10S)
{SPR_ACLO,4,1400,NULL,S_DORMANTARTI12,0,0},	// S_DORMANTARTI11
{SPR_ACLO,0,3,NULL,S_DORMANTARTI13,0,0},	// S_DORMANTARTI12
#else
...
#if (APPVER_HERETICREV < AV_HR_TIC10S)
{SPR_SPAX,32771,6,NULL,S_REDAXEX2,0,0},	// S_REDAXEX1
{SPR_SPAX,32772,6,NULL,S_REDAXEX3,0,0},	// S_REDAXEX2
{SPR_SPAX,32773,6,NULL,S_NULL,0,0},	// S_REDAXEX3
#else
